...
export interface ChainHeadV1 extends GenericJsonRpcApis {
     ...
     * @version v1
     */
    chainHead_v1_storage(subscriptionId: string, blockHash: BlockHash, items: Array<StorageQuery>, childTrie?: string | null): Promise<MethodResponse>;
    /**
     ...
     * @version v1
     */
    chainHead_v1_call(subscriptionId: string, blockHash: BlockHash, func: string, params: string): Promise<MethodResponse>;
    /**
