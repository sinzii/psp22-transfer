...
export interface ChainHeadUnstable extends GenericJsonRpcApis {
     ...
     * @version unstable
     */
    chainHead_unstable_storage(subscriptionId: string, blockHash: BlockHash, items: Array<StorageQuery>, childTrie?: string | null): Promise<MethodResponse>;
    /**
     ...
     * @version unstable
     */
    chainHead_unstable_call(subscriptionId: string, blockHash: BlockHash, func: string, params: string): Promise<MethodResponse>;
    /**
