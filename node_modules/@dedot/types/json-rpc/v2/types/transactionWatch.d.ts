...
export type TransactionWatchEvent<Hash = BlockHash> = TransactionValidated | TransactionBestChainBlockIncluded<Hash> | TransactionFinalized<Hash> | TransactionError | TransactionInvalid | TransactionDropped;
