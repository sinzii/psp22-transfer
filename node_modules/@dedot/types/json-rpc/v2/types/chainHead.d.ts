...
export type FollowOperationEvent = OperationBodyDone | OperationCallDone | OperationStorageItems | OperationWaitingForContinue | OperationStorageDone | OperationInaccessible | OperationError;
export type FollowEvent<Hash = BlockHash> = Initialized<Hash> | NewBlock<Hash> | BestBlockChanged<Hash> | Finalized<Hash> | FollowOperationEvent | ChainHeadStop;
