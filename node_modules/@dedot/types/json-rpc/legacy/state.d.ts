import { BlockHash, Bytes, Hash, Metadata, Option, PrefixedStorageKey, RuntimeVersion, StorageData, StorageKey } from '@dedot/codecs';
...
export interface StateJsonRpcApis extends GenericJsonRpcApis {
     ...
     * @param {BlockHash} at
     **/
    state_getChildReadProof: (childStorageKey: PrefixedStorageKey, keys: Array<StorageKey>, at?: BlockHash) => Promise<ReadProof>;
    /**
     ...
     * @param {BlockHash} at
     **/
    state_getKeysPaged: (prefix: Option<StorageKey>, count: number, startKey?: StorageKey, at?: BlockHash) => Promise<Array<StorageKey>>;
    /**
     ...
     **/
    state_traceBlock: (block: Hash, targets: Option<string>, storage_keys: Option<string>, methods: Option<string>) => Promise<TraceBlockResponse>;
    /**
