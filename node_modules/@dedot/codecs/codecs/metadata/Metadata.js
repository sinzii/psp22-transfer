...
import { $MetadataV15, $PalletDefV15, $RuntimeApiMethodDefV15, $SignedExtensionDefV15, $StorageEntryV15, } from './v15.js';
export const notSupportedCodec = (msg = 'Not supported!') => {
    return $.createShape({
...
export const $Metadata = $.instance(Metadata, $.Tuple($.u32, $MetadataVersioned), (metadata) => [metadata.magicNumber, metadata.metadataVersioned]);
