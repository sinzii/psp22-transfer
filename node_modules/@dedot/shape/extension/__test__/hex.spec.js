...
describe('hex', () => {
    ...
    describe('PrefixedHex', () => {
        ...
        it('should encode fixed hex', () => {
            const $prefixedHex = $.PrefixedHex;
            expect($prefixedHex.tryEncode('0x12121212')).toEqual(concatU8a($.compactU32.tryEncode(4), Uint8Array.from([18, 18, 18, 18])));
            expect($prefixedHex.tryEncode('0x121212123434')).toEqual(concatU8a($.compactU32.tryEncode(6), Uint8Array.from([18, 18, 18, 18, 52, 52])));
        });
    });
});
