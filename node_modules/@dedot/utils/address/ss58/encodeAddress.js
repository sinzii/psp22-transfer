...
export const DEFAULT_SUBSTRATE_ADDRESS_PREFIX = 42;
export const ALLOWED_DECODED_LENGTHS = [1, 2, 4, 8, 32, 33];
export function encodeAddress(key, ss58Format = DEFAULT_SUBSTRATE_ADDRESS_PREFIX) {
    ...
    const input = concatU8a(ss58Format < 64
