...
// Original Impl: https://github.com/polkadot-js/common/blob/22aab4a4e62944a2cf8c885f50be2c1b842813ec/packages/util/src/string/camelCase.ts
Object.defineProperty(exports, "__esModule", { value: true });
exports.stringUpperFirst = exports.stringLowerFirst = exports.stringDashCase = exports.stringSnakeCase = exports.stringPascalCase = exports.stringCamelCase = exports.CC_TO_LO = exports.CC_TO_UP = void 0;
...
const stringSnakeCase = (input) => {
    if (!input)
        return '';
    return (0, exports.stringCamelCase)(input).replace(/[A-Z]/g, (letter) => `_${letter.toLowerCase()}`);
};
exports.stringSnakeCase = stringSnakeCase;
const stringDashCase = (input) => {
    if (!input)
        return '';
    return (0, exports.stringCamelCase)(input)
        .replaceAll(/[A-Z]/g, (letter) => `-${letter}`)
        .toLowerCase();
};
exports.stringDashCase = stringDashCase;
const stringLowerFirst = (input) => {
    if (!input)
        return '';
    input = input.trim();
    return exports.CC_TO_LO[input.charCodeAt(0)] + input.slice(1);
};
exports.stringLowerFirst = stringLowerFirst;
const stringUpperFirst = (input) => {
    if (!input)
        return '';
    input = input.trim();
    return exports.CC_TO_UP[input.charCodeAt(0)] + input.slice(1);
};
