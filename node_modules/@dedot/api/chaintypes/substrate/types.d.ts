...
export type KitchensinkRuntimeRuntimeEvent = {
    ...
    pallet: 'Indices';
    palletEvent: PalletIndicesEvent;
} | {
    pallet: 'Balances';
    ...
    pallet: 'Staking';
    palletEvent: PalletStakingPalletEvent;
} | {
    pallet: 'Session';
    palletEvent: PalletSessionEvent;
} | {
    pallet: 'Democracy';
    palletEvent: PalletDemocracyEvent;
} | {
    pallet: 'Council';
    palletEvent: PalletCollectiveEvent;
} | {
    pallet: 'TechnicalCommittee';
    palletEvent: PalletCollectiveEvent;
} | {
    pallet: 'Elections';
    palletEvent: PalletElectionsPhragmenEvent;
} | {
    pallet: 'TechnicalMembership';
    palletEvent: PalletMembershipEvent;
} | {
    pallet: 'Grandpa';
    palletEvent: PalletGrandpaEvent;
} | {
    pallet: 'Treasury';
    palletEvent: PalletTreasuryEvent;
} | {
    pallet: 'AssetRate';
    palletEvent: PalletAssetRateEvent;
} | {
    pallet: 'Contracts';
    palletEvent: PalletContractsEvent;
} | {
    pallet: 'Sudo';
    ...
    pallet: 'Offences';
    palletEvent: PalletOffencesEvent;
} | {
    pallet: 'Identity';
    palletEvent: PalletIdentityEvent;
} | {
    pallet: 'Society';
    palletEvent: PalletSocietyEvent;
} | {
    pallet: 'Recovery';
    palletEvent: PalletRecoveryEvent;
} | {
    pallet: 'Vesting';
    palletEvent: PalletVestingEvent;
} | {
    pallet: 'Scheduler';
    palletEvent: PalletSchedulerEvent;
} | {
    pallet: 'Glutton';
    palletEvent: PalletGluttonEvent;
} | {
    pallet: 'Preimage';
    ...
    pallet: 'Bounties';
    palletEvent: PalletBountiesEvent;
} | {
    pallet: 'Tips';
    palletEvent: PalletTipsEvent;
} | {
    pallet: 'Assets';
    palletEvent: PalletAssetsEvent;
} | {
    pallet: 'PoolAssets';
    palletEvent: PalletAssetsEvent;
} | {
    pallet: 'Lottery';
    palletEvent: PalletLotteryEvent;
} | {
    pallet: 'Nis';
    palletEvent: PalletNisEvent;
} | {
    pallet: 'Uniques';
    palletEvent: PalletUniquesEvent;
} | {
    pallet: 'Nfts';
    palletEvent: PalletNftsEvent;
} | {
    pallet: 'NftFractionalization';
    palletEvent: PalletNftFractionalizationEvent;
} | {
    pallet: 'Salary';
    palletEvent: PalletSalaryEvent;
} | {
    pallet: 'CoreFellowship';
    palletEvent: PalletCoreFellowshipEvent;
} | {
    pallet: 'TransactionStorage';
    palletEvent: PalletTransactionStorageEvent;
} | {
    pallet: 'VoterList';
    palletEvent: PalletBagsListEvent;
} | {
    pallet: 'StateTrieMigration';
    palletEvent: PalletStateTrieMigrationEvent;
} | {
    pallet: 'ChildBounties';
    palletEvent: PalletChildBountiesEvent;
} | {
    pallet: 'Referenda';
    palletEvent: PalletReferendaEvent;
} | {
    pallet: 'Remark';
    palletEvent: PalletRemarkEvent;
} | {
    pallet: 'RootTesting';
    palletEvent: PalletRootTestingEvent;
} | {
    pallet: 'ConvictionVoting';
    palletEvent: PalletConvictionVotingEvent;
} | {
    pallet: 'Whitelist';
    palletEvent: PalletWhitelistEvent;
} | {
    pallet: 'AllianceMotion';
    palletEvent: PalletCollectiveEvent;
} | {
    pallet: 'Alliance';
    palletEvent: PalletAllianceEvent;
} | {
    pallet: 'NominationPools';
    palletEvent: PalletNominationPoolsEvent;
} | {
    pallet: 'RankedPolls';
    palletEvent: PalletReferendaEvent002;
} | {
    pallet: 'RankedCollective';
    palletEvent: PalletRankedCollectiveEvent;
} | {
    pallet: 'AssetConversion';
    palletEvent: PalletAssetConversionEvent;
} | {
    pallet: 'FastUnstake';
    palletEvent: PalletFastUnstakeEvent;
} | {
    pallet: 'MessageQueue';
    palletEvent: PalletMessageQueueEvent;
} | {
    pallet: 'Pov';
    palletEvent: FrameBenchmarkingPalletPovEvent;
} | {
    pallet: 'TxPause';
    palletEvent: PalletTxPauseEvent;
} | {
    pallet: 'SafeMode';
    palletEvent: PalletSafeModeEvent;
} | {
    pallet: 'Statement';
    palletEvent: PalletStatementEvent;
} | {
    pallet: 'MultiBlockMigrations';
    palletEvent: PalletMigrationsEvent;
} | {
    pallet: 'Broker';
    palletEvent: PalletBrokerEvent;
} | {
    pallet: 'Parameters';
    palletEvent: PalletParametersEvent;
} | {
...
export type PalletElectionProviderMultiPhaseElectionCompute = 'OnChain' | 'Signed' | 'Unsigned' | 'Fallback' | 'Emergency';
...
export type KitchensinkRuntimeRuntimeCall = {
    pallet: 'System';
    palletCall: FrameSystemCall;
} | {
    pallet: 'Utility';
    palletCall: PalletUtilityCall;
} | {
    pallet: 'Babe';
    palletCall: PalletBabeCall;
} | {
    pallet: 'Timestamp';
    palletCall: PalletTimestampCall;
} | {
    pallet: 'Indices';
    palletCall: PalletIndicesCall;
} | {
    pallet: 'Balances';
    palletCall: PalletBalancesCall;
} | {
    pallet: 'ElectionProviderMultiPhase';
    palletCall: PalletElectionProviderMultiPhaseCall;
} | {
    pallet: 'Staking';
    palletCall: PalletStakingPalletCall;
} | {
    pallet: 'Session';
    palletCall: PalletSessionCall;
} | {
    pallet: 'Democracy';
    palletCall: PalletDemocracyCall;
} | {
    pallet: 'Council';
    palletCall: PalletCollectiveCall;
} | {
    pallet: 'TechnicalCommittee';
    palletCall: PalletCollectiveCall;
} | {
    pallet: 'Elections';
    palletCall: PalletElectionsPhragmenCall;
} | {
    pallet: 'TechnicalMembership';
    palletCall: PalletMembershipCall;
} | {
    pallet: 'Grandpa';
    palletCall: PalletGrandpaCall;
} | {
    pallet: 'Treasury';
    palletCall: PalletTreasuryCall;
} | {
    pallet: 'AssetRate';
    palletCall: PalletAssetRateCall;
} | {
    pallet: 'Contracts';
    palletCall: PalletContractsCall;
} | {
    pallet: 'Sudo';
    palletCall: PalletSudoCall;
} | {
    pallet: 'ImOnline';
    palletCall: PalletImOnlineCall;
} | {
    pallet: 'Identity';
    palletCall: PalletIdentityCall;
} | {
    pallet: 'Society';
    palletCall: PalletSocietyCall;
} | {
    pallet: 'Recovery';
    palletCall: PalletRecoveryCall;
} | {
    pallet: 'Vesting';
    palletCall: PalletVestingCall;
} | {
    pallet: 'Scheduler';
    palletCall: PalletSchedulerCall;
} | {
    pallet: 'Glutton';
    palletCall: PalletGluttonCall;
} | {
    pallet: 'Preimage';
    palletCall: PalletPreimageCall;
} | {
    pallet: 'Proxy';
    palletCall: PalletProxyCall;
} | {
    pallet: 'Multisig';
    palletCall: PalletMultisigCall;
} | {
    pallet: 'Bounties';
    palletCall: PalletBountiesCall;
} | {
    pallet: 'Tips';
    palletCall: PalletTipsCall;
} | {
    pallet: 'Assets';
    palletCall: PalletAssetsCall;
} | {
    pallet: 'PoolAssets';
    palletCall: PalletAssetsCall;
} | {
    pallet: 'Beefy';
    palletCall: PalletBeefyCall;
} | {
    pallet: 'Lottery';
    palletCall: PalletLotteryCall;
} | {
    pallet: 'Nis';
    palletCall: PalletNisCall;
} | {
    pallet: 'Uniques';
    palletCall: PalletUniquesCall;
} | {
    pallet: 'Nfts';
    palletCall: PalletNftsCall;
} | {
    pallet: 'NftFractionalization';
    palletCall: PalletNftFractionalizationCall;
} | {
    pallet: 'Salary';
    palletCall: PalletSalaryCall;
} | {
    pallet: 'CoreFellowship';
    palletCall: PalletCoreFellowshipCall;
} | {
    pallet: 'TransactionStorage';
    palletCall: PalletTransactionStorageCall;
} | {
    pallet: 'VoterList';
    palletCall: PalletBagsListCall;
} | {
    pallet: 'StateTrieMigration';
    palletCall: PalletStateTrieMigrationCall;
} | {
    pallet: 'ChildBounties';
    palletCall: PalletChildBountiesCall;
} | {
    pallet: 'Referenda';
    palletCall: PalletReferendaCall;
} | {
    pallet: 'Remark';
    palletCall: PalletRemarkCall;
} | {
    pallet: 'RootTesting';
    palletCall: PalletRootTestingCall;
} | {
    pallet: 'ConvictionVoting';
    palletCall: PalletConvictionVotingCall;
} | {
    pallet: 'Whitelist';
    palletCall: PalletWhitelistCall;
} | {
    pallet: 'AllianceMotion';
    palletCall: PalletCollectiveCall;
} | {
    pallet: 'Alliance';
    palletCall: PalletAllianceCall;
} | {
    pallet: 'NominationPools';
    palletCall: PalletNominationPoolsCall;
} | {
    pallet: 'RankedPolls';
    palletCall: PalletReferendaCall;
} | {
    pallet: 'RankedCollective';
    palletCall: PalletRankedCollectiveCall;
} | {
    pallet: 'AssetConversion';
    palletCall: PalletAssetConversionCall;
} | {
    pallet: 'FastUnstake';
    palletCall: PalletFastUnstakeCall;
} | {
    pallet: 'MessageQueue';
    palletCall: PalletMessageQueueCall;
} | {
    pallet: 'Pov';
    palletCall: FrameBenchmarkingPalletPovCall;
} | {
    pallet: 'TxPause';
    palletCall: PalletTxPauseCall;
} | {
    pallet: 'SafeMode';
    palletCall: PalletSafeModeCall;
} | {
    pallet: 'MultiBlockMigrations';
    palletCall: PalletMigrationsCall;
} | {
    pallet: 'Broker';
    palletCall: PalletBrokerCall;
} | {
    pallet: 'Mixnet';
    palletCall: PalletMixnetCall;
} | {
    pallet: 'Parameters';
...
export type KitchensinkRuntimeRuntimeCallLike = {
    ...
    pallet: 'Indices';
    palletCall: PalletIndicesCallLike;
} | {
    pallet: 'Balances';
    ...
    pallet: 'Staking';
    palletCall: PalletStakingPalletCallLike;
} | {
    pallet: 'Session';
    palletCall: PalletSessionCallLike;
} | {
    pallet: 'Democracy';
    palletCall: PalletDemocracyCallLike;
} | {
    pallet: 'Council';
    palletCall: PalletCollectiveCallLike;
} | {
    pallet: 'TechnicalCommittee';
    palletCall: PalletCollectiveCallLike;
} | {
    pallet: 'Elections';
    palletCall: PalletElectionsPhragmenCallLike;
} | {
    pallet: 'TechnicalMembership';
    ...
    pallet: 'Treasury';
    palletCall: PalletTreasuryCallLike;
} | {
    pallet: 'AssetRate';
    palletCall: PalletAssetRateCallLike;
} | {
    pallet: 'Contracts';
    palletCall: PalletContractsCallLike;
} | {
    pallet: 'Sudo';
    ...
    pallet: 'Society';
    palletCall: PalletSocietyCallLike;
} | {
    pallet: 'Recovery';
    palletCall: PalletRecoveryCallLike;
} | {
    pallet: 'Vesting';
    palletCall: PalletVestingCallLike;
} | {
    pallet: 'Scheduler';
    palletCall: PalletSchedulerCallLike;
} | {
    pallet: 'Glutton';
    palletCall: PalletGluttonCallLike;
} | {
    pallet: 'Preimage';
    ...
    pallet: 'Bounties';
    palletCall: PalletBountiesCallLike;
} | {
    pallet: 'Tips';
    palletCall: PalletTipsCallLike;
} | {
    pallet: 'Assets';
    palletCall: PalletAssetsCallLike;
} | {
    pallet: 'PoolAssets';
    palletCall: PalletAssetsCallLike;
} | {
    pallet: 'Beefy';
    palletCall: PalletBeefyCallLike;
} | {
    pallet: 'Lottery';
    palletCall: PalletLotteryCallLike;
} | {
    pallet: 'Nis';
    palletCall: PalletNisCallLike;
} | {
    pallet: 'Uniques';
    palletCall: PalletUniquesCallLike;
} | {
    pallet: 'Nfts';
    palletCall: PalletNftsCallLike;
} | {
    pallet: 'NftFractionalization';
    palletCall: PalletNftFractionalizationCallLike;
} | {
    pallet: 'Salary';
    palletCall: PalletSalaryCallLike;
} | {
    pallet: 'CoreFellowship';
    palletCall: PalletCoreFellowshipCallLike;
} | {
    pallet: 'TransactionStorage';
    palletCall: PalletTransactionStorageCallLike;
} | {
    pallet: 'VoterList';
    palletCall: PalletBagsListCallLike;
} | {
    pallet: 'StateTrieMigration';
    palletCall: PalletStateTrieMigrationCallLike;
} | {
    pallet: 'ChildBounties';
    palletCall: PalletChildBountiesCallLike;
} | {
    pallet: 'Referenda';
    palletCall: PalletReferendaCallLike;
} | {
    pallet: 'Remark';
    palletCall: PalletRemarkCallLike;
} | {
    pallet: 'RootTesting';
    palletCall: PalletRootTestingCallLike;
} | {
    pallet: 'ConvictionVoting';
    palletCall: PalletConvictionVotingCallLike;
} | {
    pallet: 'Whitelist';
    palletCall: PalletWhitelistCallLike;
} | {
    pallet: 'AllianceMotion';
    palletCall: PalletCollectiveCallLike;
} | {
    pallet: 'Alliance';
    palletCall: PalletAllianceCallLike;
} | {
    pallet: 'NominationPools';
    palletCall: PalletNominationPoolsCallLike;
} | {
    pallet: 'RankedPolls';
    palletCall: PalletReferendaCallLike;
} | {
    ...
    pallet: 'AssetConversion';
    palletCall: PalletAssetConversionCallLike;
} | {
    pallet: 'FastUnstake';
    palletCall: PalletFastUnstakeCallLike;
} | {
    pallet: 'MessageQueue';
    palletCall: PalletMessageQueueCallLike;
} | {
    pallet: 'Pov';
    palletCall: FrameBenchmarkingPalletPovCallLike;
} | {
    pallet: 'TxPause';
    palletCall: PalletTxPauseCallLike;
} | {
    pallet: 'SafeMode';
    palletCall: PalletSafeModeCallLike;
} | {
    pallet: 'MultiBlockMigrations';
    palletCall: PalletMigrationsCallLike;
} | {
    pallet: 'Broker';
    palletCall: PalletBrokerCallLike;
} | {
    pallet: 'Mixnet';
    palletCall: PalletMixnetCallLike;
} | {
    pallet: 'Parameters';
 ...
 **/
{
    name: 'Batch';
    params: {
        calls: Array<KitchensinkRuntimeRuntimeCall>;
    };
}
/**
...
export type PalletDemocracyConviction = 'None' | 'Locked1x' | 'Locked2x' | 'Locked3x' | 'Locked4x' | 'Locked5x' | 'Locked6x';
/**
 * Contains a variant per dispatchable extrinsic that this pallet has.
 **/
 ...
 **/
 | {
    name: 'Execute';
    params: {
        proposal: KitchensinkRuntimeRuntimeCall;
        lengthBound: number;
    };
}
/**
...
export type PalletUniquesDestroyWitness = {
    items: number;
...
export type PalletNftsCollectionSetting = 'TransferableItems' | 'UnlockedMetadata' | 'UnlockedAttributes' | 'UnlockedMaxSupply' | 'DepositRequired';
...
export type PalletNftsDestroyWitness = {
    itemMetadatas: number;
    itemConfigs: number;
    attributes: number;
};
export type PalletNftsMintWitness = {
    ownedItem?: number | undefined;
    mintPrice?: bigint | undefined;
};
export type PalletNftsItemConfig = {
    settings: PalletNftsBitFlagsItemSetting;
};
export type PalletNftsCancelAttributesApprovalWitness = {
    accountAttributes: number;
};
export type PalletNftsItemTip = {
    collection: number;
    item: number;
    receiver: AccountId32;
    amount: bigint;
...
export type SpTransactionStorageProofTransactionStorageProof = {
    chunk: Bytes;
    proof: Array<Bytes>;
};
/**
...
export type PalletConvictionVotingConviction = 'None' | 'Locked1x' | 'Locked2x' | 'Locked3x' | 'Locked4x' | 'Locked5x' | 'Locked6x';
/**
 * Contains a variant per dispatchable extrinsic that this pallet has.
 **/
...
export type PalletAllianceDisbandWitness = {
    fellowMembers: number;
    allyMembers: number;
};
export type PalletAllianceCid = {
    version: PalletAllianceVersion;
    codec: bigint;
    hash: PalletAllianceMultihash;
};
export type PalletAllianceVersion = 'V0' | 'V1';
export type PalletAllianceMultihash = {
    code: bigint;
    digest: Bytes;
};
...
export type PalletSocietyPayoutRecord = {
    paid: bigint;
    payouts: Array<[number, bigint]>;
};
export type PalletSocietyBid = {
    who: AccountId32;
...
export type PalletSocietyTally = {
    approvals: number;
    rejections: number;
};
export type PalletSocietyVote = {
    approve: boolean;
    weight: number;
};
export type PalletSocietyIntakeRecord = {
    who: AccountId32;
    bid: bigint;
    round: number;
};
...
export type PalletRecoveryActiveRecovery = {
    created: number;
    deposit: bigint;
    friends: Array<AccountId32>;
};
 ...
 **/
 | 'InvalidConfiguration';
export type SpConsensusBeefyMmrBeefyAuthoritySet = {
    id: bigint;
    len: number;
...
export type PalletUniquesCollectionMetadata = {
    deposit: bigint;
    data: Bytes;
    isFrozen: boolean;
};
export type PalletUniquesItemMetadata = {
    deposit: bigint;
    data: Bytes;
    isFrozen: boolean;
};
...
export type PalletNftsItemDeposit = {
    account: AccountId32;
    amount: bigint;
};
export type PalletNftsCollectionMetadata = {
    deposit: bigint;
    data: Bytes;
};
export type PalletNftsItemMetadata = {
    deposit: PalletNftsItemMetadataDeposit;
    data: Bytes;
};
export type PalletNftsItemMetadataDeposit = {
    account?: AccountId32 | undefined;
    amount: bigint;
};
export type PalletNftsAttributeDeposit = {
    account?: AccountId32 | undefined;
    amount: bigint;
};
...
export type PalletSalaryClaimantStatus = {
    lastActive: number;
 ...
 **/
 | 'NotCurrent';
export type PalletCoreFellowshipMemberStatus = {
    isActive: boolean;
...
export type PalletRankedCollectiveMemberRecord = {
    rank: number;
};
/**
 * The `Error` enum of this pallet.
 ...
 **/
'Ongoing';
export type PalletBrokerLeaseRecordItem = {
    until: number;
    task: number;
};
...
export type PalletBrokerPoolIoRecord = {
    private: number;
    system: number;
};
...
export type SpStatementStoreRuntimeApiValidStatement = {
    maxCount: number;
    maxSize: number;
};
...
export type PalletContractsPrimitivesExecReturnValue = {
    flags: PalletContractsUapiFlagsReturnFlags;
    data: Bytes;
};
export type PalletContractsUapiFlagsReturnFlags = {
    bits: number;
};
...
export type PalletContractsPrimitivesCodeUploadReturnValue = {
    codeHash: H256;
    deposit: bigint;
};
...
export type SpConsensusBeefyValidatorSet = {
...
export type SpMixnetSessionStatus = {
    currentIndex: number;
